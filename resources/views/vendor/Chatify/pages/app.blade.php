...
<div class="messenger">
    ...
    <div class="messenger-messagingView">
        ...
        <div class="m-header m-header-messaging">
			...
			{
				$image = 'public/'.Storage::url(Auth::user()->avatar);
			}
	        ?>  
            <nav>
                ...
                <div style="display: inline-flex;">
                    ...
                    <div class="avatar av-s header-avatar" style="margin: 0px 10px; margin-top: -5px; margin-bottom: -5px;background-image: url('{{ asset($image) }}');">
                    </div>
        ...
        <div class="m-body app-scroll">
            <div style="margin-top: 2em;" class="messages">
               <p class="message-hint" style="margin-top: calc(30% - 126.2px);"><span><a href="#" class="show-listView"><i class="fas fa-arrow-left"></i>Please select a chat to start messaging</a></span></p>
            </div>
            {{-- Typing indicator --}}
