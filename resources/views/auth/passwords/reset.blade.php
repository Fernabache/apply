                        ...
                        <div class="intro-x mt-8">
                             <input id="email" placeholder="Email" type="email" class="intro-x login__input input input--lg border border-gray-300 block @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                ...
                                @enderror<br>
                                 ...
                                 <input placeholder="Confirm Password" id="password" type="password" class="intro-x login__input input input--lg border border-gray-300 block  @error('password') is-invalid @enderror"name="password_confirmation" required autocomplete="current-password"><br>
                        
                        </div>
                        <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                            <button class="button button--lg w-full xl:w-32 text-white bg-theme-1 xl:mr-3 align-top btn-block">Reset Password </button></button>
                        </div><br>
                    </form>
                   <a href="/login"> <button class="button button--lg w-full xl:w-32 text-gray-700 border border-gray-300 dark:border-dark-5 dark:text-gray-300 mt-3 xl:mt-0 align-top btn-block">Login</button></a>
                    </div>
                </div>
                <!-- END: Login Form -->
            </div>
