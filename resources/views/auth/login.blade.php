        ...
        <div class="container sm:px-10">
            <div class="block xl:grid grid-cols-2 gap-4">
                ...
                <div class="hidden xl:flex flex-col min-h-screen">
                    ...
                    <div class="my-auto">
                        <img alt="Midone Tailwind HTML Admin Template" class="-intro-x w-1/2 -mt-16" src="{{asset('applicant/images/Graduation.gif')}}">
                        <div class="-intro-x text-white font-medium text-4xl leading-tight mt-10">
                          <h1>A few more clicks to</h1> 
                ...
                <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                    <div class="my-auto mx-auto xl:ml-20 bg-white xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                        <h2 class="intro-x font-bold text-2xl xl:text-3xl text-center xl:text-left">
                            Sign In<img width="30px" src="{{asset('applicant/images/skyned.png')}}">
                        </h2><br>

                        <h3 align="center" class="font-bold"> Or sign in with  </h3>
                        <div  class="col-12">
                           <div class="contenta">
                        ...
                        <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                            <button class="button button--lg w-full xl:w-32 text-white bg-theme-1 xl:mr-3 align-top btn-block"><span>Login</span></button>
                        </div><br>
                    </form>
                   <a href="/register"> <button class="button button--lg w-full xl:w-32 text-gray-700 border border-gray-300 dark:border-dark-5 dark:text-gray-300 mt-3 xl:mt-0 align-top btn-block"><span>Sign up</span></button></a>
